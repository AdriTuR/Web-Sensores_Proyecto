...
<!----------------------------------------------ELIMINAR MENU--------------------------------------------------------->
<script>
    var removeMe = document.getElementById("userconsult");
    removeMe.innerHTML = '';
</script>
        ...
        <div class="formulario" id="formulario_consulta">
            ...
            <div id="content-consult-box">
                <form id="form_consult">
                    ...
                    <p>
                        <textarea name="consulta" class="texto_consulta" id="consulta" placeholder="Escribe tu consulta..." required maxlength="400" minlength="3"></textarea>
                    </p>
